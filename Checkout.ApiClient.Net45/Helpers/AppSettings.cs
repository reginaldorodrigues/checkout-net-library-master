...
namespace Checkout
{
    ...
    public sealed class AppSettings
    {
        ...
        private const string _sandboxUrl = "https://sandbox.checkout.com/api";
        //private const string _sandboxUrl = "http://localhost:58775/api";
        ...
        public static string ShoppingListApiKey
        {
            get { return _secretKey ?? (_secretKey = ReadConfig("ShoppingListApi.Key", true)); }
            set { _secretKey = value; }
        }

namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _shoppingItemApiUri;
        ...
        public static string ShoppingList
            => _shoppingListApiUri ?? (_shoppingListApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList"));

        public static string ShoppingItem
            => _shoppingItemApiUri ?? (_shoppingItemApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppingList/{0}"));
    }
}
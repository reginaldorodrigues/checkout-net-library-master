...
namespace Tests
{
    public class TestHelper
    {
        ...
        public static ShoppingItemCreate GetShoppingItemCreateRandomModel()
        {
            return new ShoppingItemCreate()
            {
                Drink = new Drink() { Name = RandomData.String },
                Quantity = RandomData.GetNumber(1, 5)
            };
        }

        public static ShoppingItemCreate GetShoppingItemCreateCocaColaModel()
        {
            return new ShoppingItemCreate()
            {
        ...
        public static ShoppingItemUpdate GetShoppingItemUpdateCocaColaModel()
        {
        ...
        #endregion ShoppingList Helpers
